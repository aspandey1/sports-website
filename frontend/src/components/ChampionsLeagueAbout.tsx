...
const ChampionsLeagueAbout = () => {
  return (
    <div className="lg:flex px-[2rem] md:px-[6rem] bg-gradient-to-t from-white to-slate-300 py-10 block lg:items-center ">
      <div className="flex flex-col lg:w-[40%]">
        ...
        <div className="2xl:text-3xl 2xl:leading-10 text-lg leading-8 tracking-wider w-full lg:pr-10 lg:mt-[15%] lg:text-left text-center lg:pb-0 pb-5">
          The{" "}
          <a className="2xl:text-4xl font-bold text-2xl">Champions League</a> is
